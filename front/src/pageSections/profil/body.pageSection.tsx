...
const BodyPageSection: FC<IProps> = ({
    ...
    const [panel, setPanel] = useState<"personal" | "email" | "password">("personal")
        ...
        <>
            <Grid container style={{ gap: 12, borderBottom: "1px solid #8a8888", }}>
                <Typography
                    ...
                    style={{ padding: 10, borderBottom: panel === "personal" ? "2px solid black" : undefined, cursor: "pointer" }}>
                        Informations personnelles
                </Typography>
                <Typography 
                    onClick={() => setPanel("email")} 
                    style={{ padding: 10, borderBottom: panel === "email" ? "2px solid black" : undefined, cursor: "pointer" }}>
                        Modifier votre email
                </Typography>
                <Typography 
                    onClick={() => setPanel("password")} 
                    style={{ padding: 10, borderBottom: panel === "password" ? "2px solid black" : undefined, cursor: "pointer" }}>
                        Modifier votre mot de passe
                </Typography>
            </Grid>
            {panel === "personal" && 
                <Grid item container direction="column" xs={12} md={8} lg={6} style={{ marginTop: 30, gap: 20 }}>
                    <FormControl 
                        variant="outlined" 
                        style={{ flex: 1 }}>
                    ...
                    <FormControl 
                        variant="outlined"
                        style={{ width: "100%" }}>
                            <InputLabel htmlFor="outlined-adornment-confirmpassword">Tapez votre mot de passe</InputLabel>
                            <OutlinedInput
                    ...
                    <Button onClick={handlePersonalInfosUpdate} style={{ width: "fit-content", padding: "8px 12px 4px 12px", backgroundColor: "#423e3e", color: "white" }}>
            ...
            {panel === "email" && 
                <Grid item container direction="column" xs={12} md={8} lg={6} style={{ marginTop: 30, gap: 20 }}>
                    ...
                    <Button onClick={handleEmailUpdate} style={{ width: "fit-content", padding: "8px 12px 4px 12px", backgroundColor: "#423e3e", color: "white" }}>
                        Confirmer la modification
                    </Button>
                </Grid>
            }
                ...
                <Grid item container direction="column" xs={12} md={8} lg={6} style={{ marginTop: 30, gap: 20 }}>
                    <FormControl 
                        ...
                        style={{ width: "100%" }}>
                            ...
                            />
                            {errorOldPassword.isError && <FormHelperText style={{ color: "red", margin: "3px 0px 0px 0px" }}>{errorOldPassword.message}</FormHelperText>}
                    </FormControl>                
                    <FormControl 
                        variant="outlined"
                        style={{ width: "100%" }}>
                            <InputLabel htmlFor="outlined-adornment-confirmpassword">Nouveau mot de passe</InputLabel>
                            <OutlinedInput
                                id="outlined-adornment-confirmpassword"
                                type={showNewPassword ? 'text' : 'password'}
                                value={password}
                    ...
                    <Button onClick={handlePasswordUpdate} style={{ width: "fit-content", padding: "8px 12px 4px 12px", backgroundColor: "#423e3e", color: "white" }}>
                        Confirmer la modification
                    </Button>
                </Grid>
            }
