		...
		<>
			<Grid container style={{ gap: 12, borderBottom: "1px solid #8a8888" }}>
				<Typography
					...
					style={{
						padding: 10,
						borderBottom: panel === "personal" ? "2px solid black" : undefined,
						cursor: "pointer",
					}}>
				...
				<Typography
					...
					style={{
						padding: 10,
						borderBottom: panel === "password" ? "2px solid black" : undefined,
						cursor: "pointer",
					}}>
					Modifier votre mot de passe
				</Typography>
				<ProtectedComponent allowedRoles={["USER", "SUPERUSER"]}>
					<Typography
						onClick={() => setPanel("portfolio")}
						style={{
							padding: 10,
							borderBottom: panel === "portfolio" ? "2px solid black" : undefined,
							cursor: "pointer",
						}}>
						Portfolio
					</Typography>
			...
			{panel === "portfolio" && <>{user && <UserPortfolioSectionPage userId={user?.id} />}</>}
		</>
	)
}
